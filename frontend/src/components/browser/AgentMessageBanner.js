export default function AgentMessageBanner({ message, onRelease }) {
  if (!message) return null;

  return (
    <div className="absolute top-12 left-0 right-0 z-10 mx-4">
      <div className="flex items-center justify-between gap-3 px-4 py-3 rounded-lg bg-amber-500/20 border border-amber-500/30 backdrop-blur-sm">
